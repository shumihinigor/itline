        ...
        <div class="row">
            <div class="col-lg-5 col-12">
                ...
                <div class="modal-policy mb-24">
                    <p class="p4 text-grey-3 mb-0">
                        Отправляя заявку, я подтверждаю, что ознакомлен и согласен с 
                        <a class="link orange" href="javascript:;">Соглашением о неразглашении</a> 
                        данного сайта
                    </p>
                </div>
                <div class="mb-16">
