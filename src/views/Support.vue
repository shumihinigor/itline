...
export default {
    ...
    created() {
        // seo
        this.$store.commit('setSeoTitle', "Техническая поддержка от специалистов компании ITLINE");
        this.$store.commit('setSeoDescription', "Корректно заполните форму для обращения в техническую поддержку производителя ITLINE. При появлении технических вопросов специалисты компании ITLINE оперативно осуществляют консультирование по вопросам установки и эксплуатации светодиодных табло.");
